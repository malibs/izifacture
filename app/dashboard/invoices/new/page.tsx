    ...
    <div className="space-y-8 max-w-6xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-1 min-w-0">
            <h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">Nouvelle Facture</h1>
        ...
        <div className="flex gap-3 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-brand-600 hover:bg-brand-700 text-white px-4 sm:px-5 py-2 rounded-xl text-sm font-bold transition-all shadow-lg shadow-brand-500/20 active:scale-95"
          >
            <Save className="w-4 h-4" />
            <span className="hidden sm:inline">Enregistrer la facture</span>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 space-y-8">
          <div className="premium-card p-5 sm:p-8 space-y-6 sm:space-y-8">
          ...
          <div className="premium-card p-5 sm:p-8 space-y-6">
            <div className="flex items-center justify-between gap-4">
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-sm font-bold text-brand-600 hover:text-brand-700 transition-all active:scale-95 shrink-0"
              >
            ...
            <div className="space-y-4">
              {/* Desktop header row */}
              <div className="hidden sm:grid grid-cols-12 gap-4 px-4 py-3 text-[11px] font-bold text-slate-400 uppercase tracking-widest">
              ...
              {fields.map((field, index) => (
                <div key={field.id} className="grid grid-cols-1 sm:grid-cols-12 gap-3 sm:gap-4 items-start p-4 bg-slate-50 rounded-2xl border border-slate-100 group transition-all hover:border-brand-200 hover:bg-white hover:shadow-sm animate-in slide-in-from-left-2 duration-300">
                  <div className="sm:col-span-6 space-y-1">
                    <label className="sm:hidden text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Description</label>
                    <input
                  ...
                  <div className="sm:col-span-2 grid grid-cols-2 sm:block gap-3">
                    <div className="space-y-1">
                      <label className="sm:hidden text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Qté</label>
                      <input
                        type="number"
                  ...
                  <div className="sm:col-span-3 space-y-1">
                    <label className="sm:hidden text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Prix Unit.</label>
                    <input
                      type="number"
                  ...
                  <div className="sm:col-span-1 flex justify-end sm:justify-center items-start sm:pt-2">
                    <button
                      type="button"
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="premium-card p-5 sm:p-8 space-y-6 sm:space-y-8 sm:sticky sm:top-24">
            <div className="space-y-1">
